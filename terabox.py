...
ADMINS = list(map(int, os.environ.get('ADMINS', '5997241803').split()))
if not ADMINS:
...
mongo_url = os.environ.get('MONGO_URL', 'mongodb+srv://sujanch9993:sujanch9993@cluster0.yhmdrl9.mongodb.net/?retryWrites=true&w=majority')
...
async def start_command(client, message):
    ...
    if verify_status["is_verified"]:
        ...
        join_button = InlineKeyboardButton("Join ❤️🚀", url="https://t.me/Sujan_BotZ")
        developer_button = InlineKeyboardButton("Developer ⚡️", url="https://t.me/Sujan_Bots")
        ...
        if IS_VERIFY:
            ...
            link = await get_shortlink(SHORTLINK_URL, SHORTLINK_API, f'https://t.me/TeraBoxVideoDownloaderRooBot?start=verify_{token}')
